...
// Ingest Function to send email when user books a new show
    ...
    async ({ event, step }) => {
        ...
        await sendEmail({
            ...
            body: `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
                    ...
                    <p>Enjoy the show! 🍿</p>
                    <p>Thanks for booking with us!<br/>-YrShow Team</p>
                </div>`
        })
    }
)
...
const sendShowRemainders = inngest.createFunction(
    ...
    async ({ step }) => {
        ...
        const remainderTask = await step.run
        ...
        if (remainderTask.length === 0) {
            return { sent: 0, message: 'No remainders to sent' }
        }
                ...
                remainderTask.map(task => sendEmail({
                    ...
                    body: `<div style="font-family: Arial, sans-serif; padding: 20px;"> 
                                ...
                                <p>
                                 ...
                                 <br/>
                                 <p>Enjoy the show!<br/>YrShow Team</p>
                        </div>`
                }))
            )
        })
